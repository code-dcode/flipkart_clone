...
import ElectronicProductDetailsPage from '../screens/main/ElectronicProductDetailsPage';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path='/electronicProductDetail' element={<ElectronicProductDetailsPage />} />
